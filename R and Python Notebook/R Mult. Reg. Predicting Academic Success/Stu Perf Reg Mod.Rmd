...
#### and language. This assumption appears to be latent in the data types, the chosen factors   
#### are more generally living-condition or non-subject specific. It is apparent that for the  
#### chosen causal-factors, the data is not sufficiently diverse in academic types to  
#### address the generality of their scope. In addition, this study has limited data relative  
#### to the number of the predictors. All variables suggested to be left out by this  
...
#### data documentation, which indicates restricted application.  
