...
###  Initial Fit: The Saturated Model  
...
### Second Fit  
#### A lower complxity model of 5 variables (reported significant from the saturated  
#### model report output) is fitted. All variables included are checked for significance  
#### (p < 0.01).  
```{r seven}
